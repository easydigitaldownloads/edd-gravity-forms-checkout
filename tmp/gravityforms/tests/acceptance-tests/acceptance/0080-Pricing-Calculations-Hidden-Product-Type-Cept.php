...
Purpose: Test options, confirmation page for product type hidden
*/
...
$I->wantTo( 'Test that the options and confirmation page work correctly for a hidden product type and the default confirmation page.' );
