...
Purpose: Test options, confirmation page for product type hidden with default confirmation page
*/
...
$I->amGoingTo( 'See that the product checkbox options are what is expected' );
...
$I->amGoingTo( 'Select the first checkbox option and verify that the total adjusts. There will be no adjustment on fields since they may all be selected.' );
...
$I->amGoingTo( 'Select the first radio button and verify that the other values adjust as expected.' );
$I->selectOption('form input[name=input_7]', 'Option C-1 radio|5' );
$I->expectTo( 'See the first button with no +/- amount next to it upon selecting it' );
...
//select quantity
$I->amGoingTo( 'Select 2 as the quantity from the drop down.' );
...
$I->expectTo( 'See that the chosen drop down option displays Option A: Option A-3-1.97 on the confirmation page.');
$I->see( 'Option A: Option A-3-1.97', ['xpath'=>'//tbody/tr/td/ul/li'] );

//check checkbox options
$I->expectTo( 'See the first checkbox as Option B: Option B-1-2.00 on the confirmation page.' );
$I->see( 'Option B: Option B-1-2.00', ['xpath'=>'//tbody/tr/td/ul/li[2]'] );

$I->expectTo( 'See the second checkbox as Option B: Option B-2-3.00 on the confirmation page.' );
$I->see( 'Option B: Option B-2-3.00', ['xpath'=>'//tbody/tr/td/ul/li[3]'] );

$I->expectTo( 'See the third checkbox as Option B: Option B-3-4.00 on the confirmation page.' );
$I->see( 'Option B: Option B-3-4.00', ['xpath'=>'//tbody/tr/td/ul/li[4]'] );

//check the radio button option
$I->expectTo( 'See the radio button as Option C: Option C-3-15.00 on the confirmation page.' );
$I->see( 'Option C: Option C-3-15.00', ['xpath'=>'//tbody/tr/td/ul/li[5]'] );
